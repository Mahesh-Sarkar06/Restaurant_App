...
import 'package:food_ui/foodDetails/Components/tab_bar.dart';
...
class _FoodRecipeState extends State<FoodRecipe> with SingleTickerProviderStateMixin {
            ...
            Center(
              child: SizedBox(
                ...
                child: Hero(
                  ...
                  child: Image.asset("assets/images/${widget.detail.pictureAlt}"),
                ),
              ),
            ),
            Padding(
